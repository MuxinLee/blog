...
![Two layers which intersect](./overlapping.png)
![Two layers in relation to eachother](./relation.png)
...
![Each direction numbered from one to eight in relation to the center](./directions.png)
...
![Two shapes with their centers marked and a line drawn between the two to demonstrate the angle](./angle.png)
...
![Two layers which intersect](./intersection.png)
